...
// import StarRating from "../StarRating/StarRating"; // doğru yola uyğun import et
...
//       try {
//         const res = await fetch("https://683c245328a0b0f2fdc64af0.mockapi.io/api/review/review");
//         const data = await res.json();

//         if (Array.isArray(data)) {
//           const cityReviews = data.filter(
//             (review) => review.cityId?.toLowerCase() === selectedCity.name.toLowerCase()
//           );
...
//   name: selectedCity.name, // <-- əvvəllər `name` idi, indi `cityId` qoyuruq
...
//             <button className="plan-button" onClick={() => handlePlan(selectedCity.name)}>
//               Plan a trip
//             </button>
...
//           <a href={selectedCity.more} className="learn-more" target="_blank" rel="noopener noreferrer">
//             Read more
//           </a>
//         </p>
//       </div>
...
//         <AmadeusCitySearch destinationCityCode={iataCode} destinationCityName={selectedCity.name} />
//       </div>
...
//               <input type="text" placeholder="Your name" value={newReview.username} readOnly />
//             <StarRating
...
//         <strong>
//           {typeof review.username === "string" ? review.username : review.username.username}
//         </strong>      -    <small>{review.date}</small>
//       </div>
//       <div className="review-rating">{Array(review.rate).fill("⭐").join("")}</div>
